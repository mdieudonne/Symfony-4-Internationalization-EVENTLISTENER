...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->fileMap = array(
            'App\\Controller\\SubdomainController' => __DIR__.'/getSubdomainControllerService.php',
        ...
        include_once $this->targetDirs[3].'/src/EventListener/RequestListener.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Lk72jNBKVr', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Oh7Dzc1OeZ', 0, '+xaVzkUbmp3pQ-leN-2vrf', ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getTranslatorService()
    {
        ...
        })), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\MessageSelector()), 'en', array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yaml', 1 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => ($this->targetDirs[0].'/translations'), 'debug' => true, 'resource_files' => array('de' => array(0 => ($this->targetDirs[3].'/translations/messages.de.xlf'), 1 => ($this->targetDirs[3].'/translations/messages.de.xlf')), 'en' => array(0 => ($this->targetDirs[3].'/translations/messages.en.xlf'), 1 => ($this->targetDirs[3].'/translations/messages.en.xlf')), 'fr' => array(0 => ($this->targetDirs[3].'/translations/messages.fr.xlf'), 1 => ($this->targetDirs[3].'/translations/messages.fr.xlf')), 'nl' => array(0 => ($this->targetDirs[3].'/translations/messages.nl.xlf'), 1 => ($this->targetDirs[3].'/translations/messages.nl.xlf')))));
    ...
    {
        return $this->privates['App\EventListener\RequestListener'] = new \App\EventListener\RequestListener(($this->services['twig'] ?? $this->getTwigService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZXZw3kdVNf', 0, '+xaVzkUbmp3pQ-leN-2vrf', ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LEFLB0i6-2', 0, '+xaVzkUbmp3pQ-leN-2vrf', ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VXaoS2FsGF', 0, '+xaVzkUbmp3pQ-leN-2vrf', ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
